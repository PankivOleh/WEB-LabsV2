...
const applyHistory = () => {
  ...
  document.getElementById("employee-increase").textContent = intChange(
    current.employees,
    previous.employees,
  );
  document.getElementById("income-increase").textContent = percentChange(
    current.income,
    previous.income,
  );
  document.getElementById("expense-increase").textContent = percentChange(
    current.expenses,
    previous.expenses,
  );
};
