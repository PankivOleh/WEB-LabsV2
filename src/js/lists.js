...
const initializeInvestors = () => {
    if (localStorage.getItem("investors_version") != CURRENT_INVESTORS_VERSION || localStorage.getItem("investors") === null) {
...
const initializeCompetitor = () => {
    if (localStorage.getItem("competitors_version") != CURRENT_COMPETITORS_VERSION || localStorage.getItem("competitors") === null) {
