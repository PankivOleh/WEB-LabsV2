...
const ShowChart = ({ historyData = [] }) => {
  ...
  useEffect(() => {
    ...
    const renderFinanceChart = (dataToRender) => {
      ...
      const chartNetProfits = dataToRender.map((it) => it.income - it.expenses);
    ...
    const applyChartVisibility = () => {
      ...
      const incomeChecked =
        document.getElementById("chk-income")?.checked ?? true;
      const expenseChecked =
        document.getElementById("chk-expense")?.checked ?? true;
      const netProfitChecked =
        document.getElementById("chk-profit")?.checked ?? true;
    ...
    <>
      ...
      <div className="charts__controls">
        <div className="charts__setting--interval">
          <input
            id="chart-start-date"
            className="charts__setting__input"
            type="date"
          />
          <input
            id="chart-end-date"
        ...
        <div className="chart-filter">
          ...
          <div
            className={`chart-filter__dropdown ${isFilterOpen ? "is-open" : ""}`}
          >
            ...
            <label className="chart-filter__option">
              <input
                ...
                defaultChecked
                value="income"
                className="chart-filter__checkbox"
              />
              Прибуток
            </label>
            <label className="chart-filter__option">
