...
const ModalSettings = ({ companyData, onSave }) => {
  ...
  return (
    <div>
      ...
      <div
        className={`modal-setting__backdrop ${isOpen ? "" : "visualy-hidden"} `}
      >
        <div className="modal-setting">
          ...
          <form className="modal-setting__form" onSubmit={handleSubmit}>
            ...
            <div className="form-group">
              <label className="form-group__label" htmlFor="markets">
                Ринки збуту
              </label>
              <input
                className="form-group__input"
            ...
            <div className="form-group">
              <label className="form-group__label" htmlFor="offices">
                Офіси
              </label>
              <input
                className="form-group__input"
