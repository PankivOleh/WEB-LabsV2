                    ...
                    <div className="footer__section">
                        ...
                        <ul className="footer__list">
                            <li className="footer__item">
                                <Link to="/" className="footer__link">Мій стартап</Link>
                            </li>
                            <li className="footer__item">
                                <Link to="/market" className="footer__link">Ринок</Link>
                            </li>
                            <li className="footer__item">
                                <Link to="/investors" className="footer__link">Інвестори</Link>
                            </li>
                        </ul>
                    </div>
